          ...
          <div className="overflow-x-auto rounded-lg">
            <table className={clsx(className, 'w-full')}>
              <thead className={clsx(classHeader, 'bg-neutralLight dark:bg-gunmetal')}>
                <tr>
                  {isSelect && (
                    <th rowSpan={2} colSpan={1} className="relative px-4 py-2">
                      <div className="flex h-5 items-center">
                        ...
                        {selectedItems && selectedItems.length > 0 && (
                          <div className="absolute right-[-10px] flex items-center justify-center">
                  ...
                  {columns?.map((column: any) => (
                    <th
                      ...
                      className={clsx(
                        'px-[16px] py-[8px] text-center text-xs font-semibold capitalize text-lightPrimary dark:text-santaGrey',
                        { 'text-right': column?.textAlign === 'right' },
                        { 'text-left': column?.textAlign === 'left' }
                      )}
                      key={column.id}
                    >
                      {column?.id === 'update_quantity' || column?.id === 'next_available_date' ? (
                ...
                <tr>
                  <th className="px-[16px] py-[8px] text-center text-xs font-semibold capitalize text-lightPrimary dark:text-santaGrey">
                    On hand
                  </th>
                  <th className="px-[16px] py-[8px] text-center text-xs font-semibold capitalize text-lightPrimary dark:text-santaGrey">
                    Pending
