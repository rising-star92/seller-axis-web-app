...
import { Boxes, DataPackageRule } from '../../../interface';
...
interface FormPackageRuleProps {
  ...
  handleUpdatePackageRule: (data: DataPackageRule) => void;
  handleCancelUpdate: () => void;
  isUpdate: boolean;
  handleDeleteRetailerArray: (data: DataPackageRule) => Promise<void>;
}
        ...
        <div className="absolute">
          <Dropdown mainMenu={<IconAction />} className="w-24">
            <div className="z-50 rounded-lg ">
              <Button type="button" onClick={() => handleUpdatePackageRule(row)}>
                <DetailIcon />
                Update
              </Button>
