  ...
  ({ children, content, mouseEnterDelay = 300 }) => {
    ...
    return (
      ...
      >
        <>{children}</>
        {isHovered && (
          <div className="dark:header_cus header_cus_light absolute z-10 min-w-[380px] transform rounded-lg border bg-paperLight p-2 text-lightPrimary shadow-lg ring-1 ring-black ring-opacity-5 dark:bg-darkGreen dark:text-santaGrey">
            {content}
          </div>
        )}
      </div>
